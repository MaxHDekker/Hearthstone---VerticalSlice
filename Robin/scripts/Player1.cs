...
public class Player1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        crystalText.text = manaCrystals.ToString() + "/" + manaCrystalsTotal.ToString();
    ...
    Vector2 HandPlacement(int i, float amountCards)
    {
        ...
        pos.y = bottomScreenHeight - bottomScreenHeight + 15;
    ...
    void MakeCrystals()
    {
        GameObject crystal = Instantiate(crystalPrefab, PositionCrystals(), Quaternion.Euler(270, 0, 0));
    }

    Vector3 PositionCrystals()
    {
        Vector3 pos;

        pos.x = 86f + manaCrystalsTotal * 3;
        pos.y = -111.3f;
        pos.z = 101.9f;
